                ...
                <div class="carousel-item active" style="background-image: url('img/pb1.jpg');">
                    <div class="carousel-container">
                        <div class="carousel-content container">
                            ...
                            <p class="animate__animated animate__fadeInUp">Sumber energi yang ekonomis serta efisien
                            </p>
                ...
                <div class="carousel-item" style="background-image: url('img/pb2.jpg');">
                    <div class="carousel-container">
                        <div class="carousel-content container">
                            ...
                            <p class="animate__animated animate__fadeInUp">Mesin yang memproses batubara dan H20 menjadi
                                gas metana yang nantinya akan menjadi sumber energi panas</p>
                            <a href="#industries"
...
<main id="main">
    ...
    <section id="industries" class="services">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                <h2>WASTE</h2>
                <p class="pb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-right">
                    <div class="icon"><img class="gambar" src="img/sampah/sampah1.jpg" alt="Avatar"></div>
                    <h4 class="title"><a href="">Pakan Ternak</a></h4>

                </div>
                <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                    <div class="icon"><img src="img/sampah/sampah2.jpg" alt="Avatar" class="gambar"></div>
                    <h4 class="title"><a href="">Penggaraman</a></h4>

                </div>
                <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                    <div class="icon"><img src="img/sampah/sampah3.jpg" alt="Avatar" class="gambar"></div>
                ...
                <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                    <div class="icon"><img src="img/sampah/sampah4.jpg" alt="Avatar" class="gambar"></div>
                    <h4 class="title"><a href="">Manufaktur</a></h4>
                    <!-- <p class="description">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
                        deserunt mollit anim id est laborum</p> -->
                </div>
                <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                    <div class="icon"><img src="img/sampah/sampah5.jpg" alt="Avatar" class="gambar"></div>
                    <h4 class="title"><a href="">Manufaktur</a></h4>
                </div>
                <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                    <div class="icon"><img src="img/sampah/sampah6.jpg" alt="Avatar" class="gambar"></div>
                    <h4 class="title"><a href="">Pertambangan</a></h4>
                    <!-- <p class="description">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                        praesentium voluptatum deleniti atque</p> -->
                </div>
                <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                    <div class="icon"><img src="img/sampah/sampah7.jpg" alt="Avatar" class="gambar"></div>
                ...
                <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="600">
                    <div class="icon"><img src="img/sampah/sampah8.jpg" alt="Avatar" class="gambar"></div>
                    <h4 class="title"><a href="">Bahan Kimia</a></h4>
                    <!-- <p class="description">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                        praesentium voluptatum deleniti atque</p> -->
                </div>
                <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="700">
                    <div class="icon"><img src="img/sampah/sampah9.jpg" alt="Avatar" class="gambar"></div>
